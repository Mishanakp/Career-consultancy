    ...
    <div className='homeCateg'>
      ...
      <CardActionArea>
        ...
        <CardContent className='categContent1'>
          ...
          <h2 className='categHead1'>Students</h2>
      ...
      <CardActionArea>
        ...
        <CardContent className='categContent2'>
          ...
          <Typography variant="body2" > 
          <h2 className='categHead2'>Career Change</h2>
      ...
      <CardActionArea>
        ...
        <CardContent className='categContent3'>
          ...
          <Typography variant="body2" > 
          <h2 className='categHead3'>Special Needs</h2>
      ...
      <CardActionArea>
        ...
        <CardContent className='categContent4'>
          ...
          <Typography variant="body2" > 
          <h2 className='categHead4'>Career Break</h2>
      ...
      <CardActionArea>
        ...
        <CardContent className='categContent5'>
          ...
          <Typography variant="body2" > 
          <h2 className='categHead5'>Freshers</h2>
      ...
      <CardActionArea>
        ...
        <CardContent className='categContent6'>
          ...
          <Typography variant="body2" > 
          <h2 className='categHead6'>Career Energize</h2>
