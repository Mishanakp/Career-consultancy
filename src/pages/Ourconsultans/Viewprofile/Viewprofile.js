...
<Grid item xl={4} lg={4} md={4}sm={4} xs={12}>
  ...
  <label htmlFor="imgs"><CameraAltIcon className="addition" sx={{ color:'#4A6F8A',fontSize:'55px' }}/></label>
...
<Grid item xl={6} lg={6} md={7} sm={7} xs={12}>
  <div className="email">
    <ul>
      <li>
    <p2 ><EmailIcon/> poojaroy@gmail.com</p2>
</li>
<li>
  <p2 ><LocalPhoneIcon/> +7673 89994</p2>
  </li>
  <li>
    <p2><AddLocationIcon/> Kochi, Kerala</p2>
  </li>
