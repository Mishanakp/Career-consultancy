...
export default function BasicGrid() {
  ...
  const [value2, setValue2] = React.useState('Freecharge');
...
<Grid container spacing={2}>
  ...
  <FormControl component="fieldset">
     ...
     <RadioGroup aria-label="wallet" name="wallet1" value={value2} onChange={handleChange2}>
       <FormControlLabel value="Freecharge" control={<Radio />} label="Freecharge"  id='radiobuttoncolorchange'/>
